...
export const DistribuicaoMarcasProdutos: React.FC = () => {
  ...
  // Calcular paginação
  const totalPages = Math.ceil(sortedMarcas.length / itemsPerPage)
  const startIndex = currentPage * itemsPerPage
  const currentItems = sortedMarcas.slice(startIndex, startIndex + itemsPerPage)
  ...
  return (
    <>
      ...
      <div className="space-y-4">
        ...
        {currentItems.map((marcaData, pageIndex) => {
          ...
          return (
            <div key={marca} className="flex items-center py-1">
