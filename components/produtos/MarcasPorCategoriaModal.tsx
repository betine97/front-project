      ...
      >
        {isLoading ? (
          ...
          <>
            ...
            {/* Lista completa de categorias e marcas */}
            <div className="space-y-4">
              {sortedCategorias.map((categoriaData, index) => {
                ...
                return (
                  <div key={categoria} className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center space-x-2">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-gray-500">{quantidade} marcas</div>
                        </div>
                      </div>
                    ...
                    {/* Lista completa de marcas da categoria */}
                    <div className="flex flex-wrap gap-2">
                      {marcas.map((marca, marcaIndex) => (
                        <span
                          key={marca}
